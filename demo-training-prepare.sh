...
#mkdir -p data
#aria2c -x 16 --continue -o data/minipile.idx https://hf-mirror.com/datasets/BlinkDL/minipile-tokenized/resolve/main/rwkv_vocab_v20230424/minipile.idx
#aria2c -x 16 --continue -o data/minipile.bin https://hf-mirror.com/datasets/BlinkDL/minipile-tokenized/resolve/main/rwkv_vocab_v20230424/minipile.bin
...
#
python train.py --wandb "rwkv-dev" --proj_dir $PROJ_DIR \
 --data_file "data/demo" --data_type "binidx" --vocab_size 8621 --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --my_pile_stage 1 --epoch_count 1 --epoch_begin 0 \
 --epoch_save 1 --weight_decay 0 --head_size_a 64 \
 --num_nodes 1 --micro_bsz 1 --n_layer $N_LAYER --n_embd $N_EMBD --pre_ffn 0 --head_qk 0 --my_exit_tokens 21211500 --magic_prime 41411 \
