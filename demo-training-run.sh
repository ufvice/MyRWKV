...
#
python train.py --load_model "/home/ufvice/projects/RWKV-v5/RWKV-x070-0.1B-8621.pth" --wandb "rwkv-dev" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --my_pile_stage 0 --load_partial 1 --epoch_count 999999 --epoch_begin 0 \
 --data_file "data/demo" --my_exit_tokens 21211500 --magic_prime 41411 \
 --num_nodes $N_NODE --micro_bsz $M_BSZ --n_layer $N_LAYER --n_embd $N_EMBD --pre_ffn 0 --head_qk 0 \
 --lr_init $LR_INIT --lr_final $LR_FINAL --warmup_steps 10 --beta1 0.9 --beta2 0.99 --adam_eps 1e-18 --my_pile_edecay 0 --data_type "binidx" --vocab_size 8621 \
